...
static const _Motion_type_support_symbol_names_t _Motion_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orca_msgs, msg, Motion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, orca_msgs, msg, Motion)),
  }
};
...
{
  return &::orca_msgs::msg::rosidl_typesupport_cpp::Motion_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, orca_msgs, msg, Motion)() {
  return get_message_type_support_handle<orca_msgs::msg::Motion>();
}
