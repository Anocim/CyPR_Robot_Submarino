...
static const _Effort_type_support_symbol_names_t _Effort_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orca_msgs, msg, Effort)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, orca_msgs, msg, Effort)),
  }
};
...
{
  return &::orca_msgs::msg::rosidl_typesupport_cpp::Effort_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, orca_msgs, msg, Effort)() {
  return get_message_type_support_handle<orca_msgs::msg::Effort>();
}
