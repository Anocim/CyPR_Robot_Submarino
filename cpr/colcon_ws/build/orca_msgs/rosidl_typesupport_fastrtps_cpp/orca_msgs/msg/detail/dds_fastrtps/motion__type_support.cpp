...
#include "orca_msgs/msg/detail/motion__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: accel_model
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.accel_model,
    cdr);
  // Member: accel_drag
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.accel_drag,
    cdr);
  // Member: accel_total
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.accel_total,
    cdr);
  // Member: vel
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.vel,
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: effort
  orca_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.effort,
    cdr);
  return true;
}
  ...
  orca_msgs::msg::Motion & ros_message)
{
  ...
  // Member: effort
  orca_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    orca_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: effort
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        orca_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Effort(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = orca_msgs::msg::Motion;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const orca_msgs::msg::Motion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<orca_msgs::msg::Motion *>(
    untyped_ros_message);
...
{
  return &orca_msgs::msg::typesupport_fastrtps_cpp::_Motion__handle;
}
