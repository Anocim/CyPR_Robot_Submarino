...
#include "orb_slam2_ros/srv/detail/save_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const orb_slam2_ros::srv::SaveMap_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  orb_slam2_ros::srv::SaveMap_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = orb_slam2_ros::srv::SaveMap_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const orb_slam2_ros::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<orb_slam2_ros::srv::SaveMap_Request *>(
    untyped_ros_message);
...
get_message_type_support_handle<orb_slam2_ros::srv::SaveMap_Request>()
{
  return &orb_slam2_ros::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orb_slam2_ros, srv, SaveMap_Request)() {
  return &orb_slam2_ros::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_orb_slam2_ros
cdr_serialize(
  const orb_slam2_ros::srv::SaveMap_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  orb_slam2_ros::srv::SaveMap_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = orb_slam2_ros::srv::SaveMap_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const orb_slam2_ros::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<orb_slam2_ros::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_orb_slam2_ros
const rosidl_message_type_support_t *
get_message_type_support_handle<orb_slam2_ros::srv::SaveMap_Response>()
{
  return &orb_slam2_ros::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orb_slam2_ros, srv, SaveMap_Response)() {
  return &orb_slam2_ros::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
get_service_type_support_handle<orb_slam2_ros::srv::SaveMap>()
{
  return &orb_slam2_ros::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orb_slam2_ros, srv, SaveMap)() {
  return &orb_slam2_ros::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
