...
static const _Status_type_support_symbol_names_t _Status_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orb_slam2_ros, msg, Status)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, orb_slam2_ros, msg, Status)),
  }
};
...
{
  return &::orb_slam2_ros::msg::rosidl_typesupport_cpp::Status_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, orb_slam2_ros, msg, Status)() {
  return get_message_type_support_handle<orb_slam2_ros::msg::Status>();
}
